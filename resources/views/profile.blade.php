...
@section('contents')
    ...
    <hr />
        <form method="POST" enctype="multipart/form-data" id="profile_setup_frm" action="">
            <div class="row">
                <div class="col-md-12 border-right" style="padding-top: 10px; margin-left: 16%;">
                    <div class="p-3 py-5">
                        ...
                        <div class="mt-5 text-left"><button id="btn" class="btn btn-primary profile-button" type="submit">Save Profile</button></div>
                    </div>
                </div>
            </div>
        </form>
