...
<ul class="navbar-nav bg-sheen-green sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- <li class="nav-item">
                <class="nav-link collapsed" href="{{ route('products') }}" >View Products</a>data-toggle="collapse" data-target="#collapsePages"
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('product_categories') }}">View Product Categories</a> -->
                    <!-- </div>
                </div>
            </li> --> 
