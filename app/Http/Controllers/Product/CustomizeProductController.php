...
class CustomizeProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('customize_products.index', compact('products'))
    ...
    {
        return view('customize_products.create');
    }
...
public function store(Request $request)
{
    ...
    return redirect()->route('customize_products')->with('success', 'Product added successfully');
}
    ...
    public function show(string $id)
    {
        ...
        return view('customize_products.show', compact('product'));
    }
